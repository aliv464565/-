...
const Navigation = () => {
    ...
    // Vars
    //drawer isCollapsed برای باز بسته بودن  isHovered زمان hover
        ...
        >
            ...
            <NavHeader>
                ...
                {!(isCollapsed && !isHovered) && (
                    <NavCollapseIcons
                        lockedIcon={<MinusCircleIcon width={20} />}
                        unlockedIcon={<PlusCircleIcon width={20} />}
                        closeIcon={<XCircleIcon width={20} />}
                        onClick={() =>
