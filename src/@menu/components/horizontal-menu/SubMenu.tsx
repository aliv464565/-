...
const SubMenu: ForwardRefRenderFunction<HTMLLIElement, SubMenuProps> = (props, ref) => {
    ...
    const { y, refs, floatingStyles, context } = useFloating({
        ...
        placement:
            level > 0 ? (dir.current !== 'rtl' ? 'right-start' : 'left-start') : 'bottom-start',
        middleware: [
            offset({
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        {/* // eslint-disable-next-line lines-around-comment /* Expanded Arrow Icon */}
                        <StyledHorizontalNavExpandIcon level={level}>
                            <ChevronRightIcon width={20} fontSize="1rem" />
